...
//   useEffect(() => {
//     const price = params.price ? JSON.parse(params.price as string) : 0;
//     setAmount(price);
//   }, [params.price]);
...
//         Alert.alert("Payment Initiated", "Did the payment succeed?", [
...
//         {/* Note Input */}
//         <View className="mb-6">
//           <Text className="text-indigo-300 mb-2 font-medium">
...
const UPIPaymentScreen = () => {
  ...
  // Use useEffect to set the amount when params are available
  useEffect(() => {
    const price = params.price ? JSON.parse(params.price as string) : 0;
